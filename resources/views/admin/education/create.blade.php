        ...
        <form action="{{ route('admin.education.store') }}" method="POST" enctype="multipart/form-data" id="educationForm" class="form-container">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="judul" class="form-input" value="{{ old('judul') }}" required placeholder="Masukkan judul konten">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="penulis" class="form-input" value="{{ old('penulis') }}" required placeholder="Nama penulis">
            ...
            <div class="form-group">
                ...
                <textarea name="ringkasan" class="form-textarea" required placeholder="Tulis ringkasan singkat tentang konten ini">{{ old('ringkasan') }}</textarea>
            ...
            <!-- Waktu Baca Section yang lebih rapi -->
            <div class="waktu-baca-section">
                <div class="waktu-baca-content">
                    ...
                    <div class="waktu-baca-input">
                        <input type="number" name="waktu_baca" class="form-input" min="1" max="120" value="{{ old('waktu_baca', 5) }}" required style="max-width: 80px;">
            ...
            <button type="submit" class="btn-submit">
                <i class="bi bi-send-check"></i> Publish Content
            </button>
        </form>
    </div>
@endsection
